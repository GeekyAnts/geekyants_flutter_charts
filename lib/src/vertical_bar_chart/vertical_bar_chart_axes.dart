...
class VerticalBarChartAxes extends LeafRenderObjectWidget {
  /// Creates a [VerticalBarChartAxes] widget.
  ///
  const VerticalBarChartAxes({
    Key? key,
  }) : super(key: key);

  @override
  RenderObject createRenderObject(BuildContext context) {
    return RenderVerticalBarChartAxes();
  }

  @override
  void updateRenderObject(
      BuildContext context, covariant RenderVerticalBarChartAxes renderObject) {
    renderObject;
  }
}
...
class RenderVerticalBarChartAxes extends RenderBox {
  /// Creates a [RenderVerticalBarChartAxes] object.
  ///
