...
class RenderBarChartLabel extends RenderBox {
  ...
  RenderBarChartLabel({
    ...
    required List<double> xAxisData,
  ...
  List<double> get xAxisData => renderXAxisData;
  set xAxisData(List<double> value) {
    if (renderXAxisData != value) {
      renderXAxisData = value;
      markNeedsLayout();
    }
  }
